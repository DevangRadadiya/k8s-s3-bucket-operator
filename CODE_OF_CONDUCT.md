...
When an incident does occur, it is important to report it promptly. To report a possible violation, contact the project maintainers through GitHub (repository owners) and include relevant context (links, screenshots, logs, and witnesses if available). For sensitive reports, use a private channel (for example, maintainer email or direct GitHub contact) rather than a public issue.
...
This Code of Conduct applies within all community spaces, and also applies when an individual is officially representing our community in public or other spaces. Examples of representing our community include using an official email address, posting via an official social media account, or acting as an appointed representative at an online or offline event.
